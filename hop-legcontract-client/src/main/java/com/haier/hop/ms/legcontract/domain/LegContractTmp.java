 ...
 * @since 2019-12-09
 */
@TableName("leg_contract_tmp")
public class LegContractTmp extends Model<LegContractTmp> {
	 ...
	 * 是否有用印初审/复审
	 */
	@TableField("IS_SEAL_REVIEW")
	private String isSealReview;
	/**
	 * 退回原因
	 */
	...
	/**
	 * 是否为关联交易 1：关联交易，2：非关联交易
	 */
	@TableField("RELATED_TRAN")
	private String relatedTran;
	/**
	 * 是否跳过三自平台 1：跳过
	 */
	@TableField("ISJUMPOVER")
	private String isjumpover;
	/**
	 * 关联项目名称
	 */
	@TableField(exist = false)
	private String glProjectName;
     ...
     * 招标系统
     */
    @TableField("TENDER_SYS")
    private String tenderSys;
    ...
    public String getTenderSys() {
        return tenderSys;
    }

    public void setTenderSys(String tenderSys) {
        this.tenderSys = tenderSys;
    }

	public String getGlProjectName() {
		return glProjectName;
	}

	public void setGlProjectName(String glProjectName) {
		this.glProjectName = glProjectName;
	}
	...
	public String getIsSealReview() {
		return isSealReview;
	}

	public void setIsSealReview(String isSealReview) {
		this.isSealReview = isSealReview;
	}
	...
	public String getRelatedTran() {
		return relatedTran;
	}

	public void setRelatedTran(String relatedTran) {
		this.relatedTran = relatedTran;
	}
	...
	public String toString() {
		return "LegContractTmp{" + "rowId=" + rowId + ", projectCode=" + projectCode + ", projectName=" + projectName
				+ ", bizCode=" + bizCode + ", contractCode=" + contractCode + ", contractName=" + contractName
				+ ", backgroud=" + backgroud + ", payAmount=" + payAmount + ", payCurrency=" + payCurrency + ", payCny="
				+ payCny + ", upperAmount=" + upperAmount + ", corpore=" + corpore + ", url=" + url + ", beginDate="
				+ beginDate + ", endDate=" + endDate + ", applierId=" + applierId + ", createTime=" + createTime
				+ ", sysId=" + sysId + ", procId=" + procId + ", contNo=" + contNo + ", contStatus=" + contStatus
				+ ", payType=" + payType + ", materPayType=" + materPayType + ", signDate=" + signDate
				+ ", isBegintoend=" + isBegintoend + ", contractNum=" + contractNum + ", bizName=" + bizName
				+ ", applierName=" + applierName + ", isMajor=" + isMajor + ", projectAppid=" + projectAppid
				+ ", strategy=" + strategy + ", contractDes=" + contractDes + ", draftType=" + draftType + ", proType="
				+ proType + ", contractPartnerList=" + contractPartnerList + ", contractType=" + contractType
				+ ", contractPartner1=" + contractPartner1 + ", contractPartner2=" + contractPartner2
				+ ", partnersName=" + partnersName + ", contractNo=" + contractNo + ", isCompare=" + isCompare
				+ ", contractAlias=" + contractAlias + ", contractPhone=" + contractPhone + ", contractEmail="
				+ contractEmail + ", riskPlan=" + riskPlan + ", effectiveDate=" + effectiveDate + ", isChange="
				+ isChange + ", isBcc=" + isBcc + ", projectId=" + projectId + ", isAssessed=" + isAssessed
				+ ", isLawAudit=" + isLawAudit + ", isPlatformLawAudit=" + isPlatformLawAudit + ", hasErrorLaw="
				+ hasErrorLaw + ", hasErrorPlatform=" + hasErrorPlatform + ", sealType=" + sealType + ", rspUrl="
				+ rspUrl + ", isFastChannel=" + isFastChannel + ", isMasscontract=" + isMasscontract
				+ ", relaMassProcid=" + relaMassProcid + ", language=" + language + ", contractInsideType="
				+ contractInsideType + ", contractAmountMax=" + contractAmountMax + ", adverseUser=" + adverseUser
				+ ", contractCompanyType=" + contractCompanyType + ", companyIndustry=" + companyIndustry
				+ ", tradingProject=" + tradingProject + ", mecContractCode=" + mecContractCode
				+ ", contractAmountAllMax=" + contractAmountAllMax + ", estimateCny=" + estimateCny + ", isAutoSeal="
				+ isAutoSeal + ", isOccupiedAmount=" + isOccupiedAmount + ", deposit=" + deposit + ", massSealType="
				+ massSealType + ", isSealReview=" + isSealReview + ", returnReason=" + returnReason + ", caseNo="
				+ caseNo + ", isModify=" + isModify + ", receiveAmount=" + receiveAmount + ", receiveCurrency="
				+ receiveCurrency + ", relatedTran=" + relatedTran + ", isjumpover=" + isjumpover + ", backNumber=" 
				+ backNumber + ", hasTender=" + hasTender + ", tenderCode=" + tenderCode + ", tenderSys=" + tenderSys +"}";
	}
}
