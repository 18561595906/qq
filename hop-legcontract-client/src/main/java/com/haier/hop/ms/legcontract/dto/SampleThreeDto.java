...
public class SampleThreeDto {
	...
	public List<LegStandardContract> getTmpChanges() {
		return tmpChanges;
	}

	public void setTmpChanges(List<LegStandardContract> tmpChanges) {
		this.tmpChanges = tmpChanges;
	}
