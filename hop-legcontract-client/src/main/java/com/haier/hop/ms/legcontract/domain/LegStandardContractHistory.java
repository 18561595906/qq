 ...
 * @since 2019-06-14
 */
@TableName("leg_standard_contract_history")
public class LegStandardContractHistory extends Model<LegStandardContractHistory> {
	...
	public String toString() {
		return "LegStandardContractHistory{" + "rowId=" + rowId + ", empSn=" + empSn + ", contractType=" + contractType
				...
				+ changeContractType + ", businessUnitType=" + businessUnitType + ", ldgyApproval=" + ldgyApproval
				+ ", isFastChannelType=" + isFastChannelType + ", contractType1=" + contractType1 + ", contractType2="
				+ contractType2 + ", ruleType=" + ruleType + "}";
	}
}
