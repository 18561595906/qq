 ...
 * @since 2020-04-02
 */
@TableName("leg_registration_info_dzht_tmp")
public class LegRegistrationInfoDzhtTmp extends Model<LegRegistrationInfoDzhtTmp> {
    ...
    public String toString() {
        return "LegRegistrationInfoDzhtTmp{" +
        "rowId=" + rowId +
        ", companyVCode=" + companyVCode +
        ...
        ", bankCard=" + bankCard +
        ", haierHandlerName=" + haierHandlerName +
        ", haierHandlerCode=" + haierHandlerCode +
        ...
        ", bizLicensePic=" + bizLicensePic +
        ", userId=" + userId +
        ", approveFlag=" + approveFlag +
        ", hucUserName=" + hucUserName +
        ", fromSys=" + fromSys +
        ", fddApproveFlag=" + fddApproveFlag +
        ", bankName=" + bankName +
        ", bankId=" + bankId +
        ", subbranchName=" + subbranchName +
        ", subbranchProvince=" + subbranchProvince +
        ", subbranchCity=" + subbranchCity +
        ", legalName=" + legalName +
        ", legalId=" + legalId +
        ", legalMobile=" + legalMobile +
        ", legalIdImage=" + legalIdImage +
        ", checkFlag=" + checkFlag +
        ", paymoneytime=" + paymoneytime +
        ", fddRemark=" + fddRemark +
        ", legalHandImage=" + legalHandImage +
