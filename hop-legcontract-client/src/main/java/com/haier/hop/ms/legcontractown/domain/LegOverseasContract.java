 ...
 * @since 2020-04-16
 */
@TableName("leg_overseas_contract")
public class LegOverseasContract extends Model<LegOverseasContract> {
	...
	public String toString() {
		return "LegOverseasContract{" + "rowId=" + rowId + ", contId=" + contId + ", contNo=" + contNo + ", applierId="
				+ applierId + ", operaters=" + operaters + ", custInfo=" + custInfo + ", custNo=" + custNo
				+ ", country=" + country + ", custXw=" + custXw + ", marketXw=" + marketXw + ", custCategory="
				...
				+ ", conPriceAverage=" + conPriceAverage + ", contractType=" + contractType + ", contractLanguage="
				+ contractLanguage + ", custXwCode=" + custXwCode + ", marketXwCode=" + marketXwCode + ", contractSum="
				+ contractSum + ", contractContext=" + contractContext + ", sealFileName=" + sealFileName
				+ ", sealPageNum=" + sealPageNum + ", sealFileNum=" + sealFileNum + ", sealNum=" + sealNum
				+ ", reasonsForLoss=" + reasonsForLoss + ", schemeOrOther=" + schemeOrOther + ", isLoss=" + isLoss
				+ "}";
	}
}
