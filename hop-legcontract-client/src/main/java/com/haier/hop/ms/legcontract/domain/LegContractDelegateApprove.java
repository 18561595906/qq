 ...
 * @since 2019-09-20
 */
@TableName("leg_contract_delegate_approve")
public class LegContractDelegateApprove extends Model<LegContractDelegateApprove> {
	...
	public String toString() {
		return "LegContractDelegateApprove{" + "rowId=" + rowId + ", auditOpinion=" + auditOpinion + ", relaId="
				+ relaId + ", createDate=" + createDate + ", createByEmpSn=" + createByEmpSn + ", createByEmpName="
				+ createByEmpName + ", delflag=" + delflag + "}";
	}
}
