 ...
 * @since 2019-07-16
 */
@TableName("leg_contract_app_node_tmp")
public class LegContractAppNodeTmp extends Model<LegContractAppNodeTmp> {
	...
	public String toString() {
		return "LegContractAppNodeTmp{" + "rowId=" + rowId + ", businessUnitRate=" + businessUnitRate
				+ ", businessUnitCode=" + businessUnitCode + ", businessUnitName=" + businessUnitName
				+ ", contractType1Sn=" + contractType1Sn + ", contractType1=" + contractType1 + ", contractType2Sn="
				+ contractType2Sn + ", contractType2=" + contractType2 + ", contractCode=" + contractCode
				+ ", contractName=" + contractName + ", nodeId=" + nodeId + ", nodeName=" + nodeName + ", createDate="
