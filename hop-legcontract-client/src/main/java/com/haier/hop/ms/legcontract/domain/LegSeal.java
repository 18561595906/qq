 ...
 */
@TableName("leg_seal")
public class LegSeal extends Model<LegSeal> {
	...
	/**
	 * 印章状态（印章状态: 0: 撤销中 99：已撤销;变更的销毁中：25 1:申请中；2：生效；5:销毁）
	 */
	...
	/**
	 * 需要销毁的标记(发起印章刻制申请的人员通过刻章申请页面进行选择的
	 */
	private String sign;
	/**
	 * 标记操作的人账号
	 */
	@TableField("sign_user_no")
	 ...
	 * 标记生效时间
	 */
	@TableField("sign_user_date")
	private Date signUserDate;
	/**
	 * F销毁流程已提报还未生效T已生效
	 */
	...
	public Integer getSettlFlag() {
		return settlFlag;
	}

	public void setSettlFlag(Integer settlFlag) {
	...
	public Date getSignUserDate() {
		return signUserDate;
	}

	public void setSignUserDate(Date signUserDate) {
		this.signUserDate = signUserDate;
	}
	...
	public String toString() {
		return "LegSeal{" + "rowId=" + rowId + ", applyId=" + applyId + ", sealCompano=" + sealCompano + ", sealComp="
				+ sealComp + ", sealNo=" + sealNo + ", sealTypeId=" + sealTypeId + ", makeMate=" + makeMate
				+ ", sealName=" + sealName + ", restrLimit=" + restrLimit + ", signedLimit=" + signedLimit
				...
				+ receiveUseridno + ", sign=" + sign + ", signUserNo=" + signUserNo + ", signUserName=" + signUserName
				+ ", signUserDate=" + signUserDate + ", signFlag=" + signFlag + ", updateDate=" + updateDate + "}";
	}
}
