...
public class LegCountersign extends Model<LegCountersign> {
	...
	/*
	 * public BigDecimal getRowId() { return rowId; } public void
	 * setRowId(BigDecimal rowId) { this.rowId = rowId; }
	 */
	...
	public String toString() {
		return "LegCountersign{" + "rowId=" + rowId + ", procId=" + procId + ", nodeId=" + nodeId + ", nodeName="
