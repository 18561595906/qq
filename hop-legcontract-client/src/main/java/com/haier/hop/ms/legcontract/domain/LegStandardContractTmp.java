 ...
 * @since 2019-07-29
 */
@TableName("leg_standard_contract_tmp")
public class LegStandardContractTmp extends Model<LegStandardContractTmp> {
	...
	/**
	 * 需求类型（new：新增 update：更新 destroy：废止）
	 */
	 ...
	 * 一级合同编码
	 */
	@TableField("CONTRACT_TYPE_SN1")
	private String contractTypeSn1;
	/**
	 * 二级合同编码
	 */
	@TableField("CONTRACT_TYPE_SN2")
	private String contractTypeSn2;
	/**
	 * 一级合同名称
	 */
	...
	public String getContractTypeSn1() {
		return contractTypeSn1;
	}

	public void setContractTypeSn1(String contractTypeSn1) {
		this.contractTypeSn1 = contractTypeSn1;
	}

	public String getContractTypeSn2() {
		return contractTypeSn2;
	}

	public void setContractTypeSn2(String contractTypeSn2) {
		this.contractTypeSn2 = contractTypeSn2;
	}
	...
	public String toString() {
		return "LegStandardContractTmp{" + "rowId=" + rowId + ", empSn=" + empSn + ", contractType=" + contractType
				+ ", contractTypeName=" + contractTypeName + ", businessUnit=" + businessUnit + ", businessUnitName="
				+ businessUnitName + ", procId=" + procId + ", contractName=" + contractName + ", contractSn="
				+ contractSn + ", contractDesc=" + contractDesc + ", contractState=" + contractState + ", version="
